...
public class HDF5GettersV2 {
	...
	public static double get_analysis_sample_rate(H5File h5, int songidx)
			throws Exception {
		return get_member_int(h5, songidx, "/analysis/songs",
	...
	public static double[] get_bars_confidence(H5File h5, int songidx)
			throws Exception {
		try {
			return get_array_double(h5, songidx, "analysis", "bars_confidence",
					1);
		} catch (Exception e) {
			double[] d = {};
			return d;
	...
	public static int[] get_artist_mbtags_count(H5File h5, int songidx)
			throws Exception {
		try {
			return get_array_int(h5, songidx, "musicbrainz",
					"artist_mbtags_count", "idx_artist_mbtags");
		} catch (Exception e) {
			int[] i = {};
			return i;
		}
	...
	public static void extractSongInfo(String filename, FileWriter fw) {
		...
		try {
			...
			strCon.append(get_analysis_sample_rate(h5) + "\t");
			strCon.append(get_artist_7digitalid(h5) + "\t");
			strCon.append(new Double(get_artist_familiarity(h5)).toString()
					+ "\t");
			strCon.append(new Double(get_artist_hotttnesss(h5)).toString()
					+ "\t");
			strCon.append(get_artist_id(h5) + "\t");
			String latlong = new Double(get_artist_latitude(h5)).toString();
			strCon.append(latlong.equals("NaN") ? "\t" : latlong + "\t");
			strCon.append(get_artist_location(h5) + "\t");
			latlong = new Double(get_artist_longitude(h5)).toString();
			strCon.append(latlong.equals("NaN") ? "\t" : latlong + "\t");
			strCon.append(get_artist_mbid(h5) + "\t");
			strCon.append(Arrays.toString(get_artist_mbtags(h5)) + "\t");
			strCon.append(Arrays.toString(get_artist_mbtags_count(h5)) + "\t");
			strCon.append(get_artist_name(h5) + "\t");
			strCon.append(get_artist_playmeid(h5) + "\t");
			strCon.append(Arrays.toString(get_artist_terms(h5)) + "\t");
			strCon.append(Arrays.toString(get_artist_terms_freq(h5)) + "\t");
			strCon.append(Arrays.toString(get_artist_terms_weight(h5)) + "\t");
			strCon.append(get_audio_md5(h5) + "\t");
			strCon.append(Arrays.toString(get_bars_confidence(h5)) + "\t");
			strCon.append(Arrays.toString(get_bars_start(h5)) + "\t");
			strCon.append(Arrays.toString(get_beats_confidence(h5)) + "\t");
			strCon.append(Arrays.toString(get_beats_start(h5)) + "\t");
			strCon.append(get_danceability(h5) + "\t");
			strCon.append(get_duration(h5) + "\t");
			strCon.append(get_end_of_fade_in(h5) + "\t");
			strCon.append(get_energy(h5) + "\t");
			strCon.append(get_key(h5) + "\t");
			strCon.append(get_key_confidence(h5) + "\t");
			strCon.append(get_loudness(h5) + "\t");
			strCon.append(get_mode(h5) + "\t");
			strCon.append(get_mode_confidence(h5) + "\t");
			strCon.append(get_release(h5) + "\t");
			strCon.append(get_release_7digitalid(h5) + "\t");
			strCon.append(Arrays.toString(get_sections_confidence(h5)) + "\t");
			strCon.append(Arrays.toString(get_sections_start(h5)) + "\t");
			strCon.append(Arrays.toString(get_segments_confidence(h5)) + "\t");
			strCon.append(Arrays.toString(get_segments_loudness_max(h5)) + "\t");
			strCon.append(Arrays.toString(get_segments_loudness_max_time(h5))
					+ "\t");
			strCon.append(Arrays.toString(get_segments_loudness_start(h5))
					+ "\t");
			strCon.append(Arrays.toString(get_segments_pitches(h5)) + "\t");
			strCon.append(Arrays.toString(get_segments_start(h5)) + "\t");
			strCon.append(Arrays.toString(get_segments_timbre(h5)) + "\t");
			strCon.append(Arrays.toString(get_similar_artists(h5)) + "\t");
			String hot = new Double(get_song_hotttnesss(h5)).toString();
			strCon.append(hot.equals("NaN") ? "\t" : hot + "\t");
			strCon.append(get_song_id(h5) + "\t");
			strCon.append(get_start_of_fade_out(h5) + "\t");
			strCon.append(Arrays.toString(get_tatums_confidence(h5)) + "\t");
			strCon.append(Arrays.toString(get_tatums_start(h5)) + "\t");
			strCon.append(get_tempo(h5) + "\t");
			strCon.append(get_time_signature(h5) + "\t");
			strCon.append(get_time_signature_confidence(h5) + "\t");
			strCon.append(get_title(h5) + "\t");
			strCon.append(get_track_id(h5) + "\t");
			strCon.append(get_track_7digitalid(h5) + "\t");
			strCon.append(get_year(h5) + " ");
			strCon.append("\n");

			fw.write(strCon.toString());
			fw.flush();
		} catch (Exception e) {
	...
	public static void main(String[] args) throws Exception {
		...
		File fileToWrite = new File("/Users/rohan/songOutputA.txt");
